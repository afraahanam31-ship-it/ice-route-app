...
# Base Map Setup (Using standard OpenStreetMap to avoid API key overlay)
...
# 3. Dynamic Moving Vessel Marker (Now anchored strictly to the voyage path)
folium.Marker(
...
# 5. Full Optimized Route Corridor
safe_route = [
    [-65.0, -64.0],
    [-64.5, -63.5],
    [ice_drift_lat - 0.3, ice_drift_lon - 0.2],
